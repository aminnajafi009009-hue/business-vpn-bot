...
async def purchase_history(callback: types.CallbackQuery):
    ...
    await show_menu_with_sticker(callback.bot, callback.message.chat.id, "purchase_history", text, reply_markup=back_button("profile", "🔙 بازگشت", screen="purchase_history"))
    await callback.answer()
