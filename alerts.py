    ...
    *,
    ...
    if bot_username:
        reply_markup = InlineKeyboardMarkup(inline_keyboard=[[
            InlineKeyboardButton(text="🟢 تست و خرید", url=f"https://t.me/{bot_username}", style="success")
        ]])
    try:
        await bot.send_message(int(bot_info.get("order_log_channel_id")), text, reply_markup=reply_markup)
    except Exception:
