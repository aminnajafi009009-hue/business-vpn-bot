    ...
    try:
        ...
        if effective_ui_key:
            ...
            if raw_entities:
                ...
                parse_mode = None
        # برای متن‌های بدون ui_key نیز catalog سراسری تلاش می‌کند پیام واقعی را پیدا کند.
        # اگر متن از قبل توسط override صفحه تغییر کرده باشد، apply_auto_text دیگر آن را
        # با template خام اشتباه نمی‌گیرد.
        text = ui_editor.apply_auto_text(text)
    except Exception:
