            ...
            for payment in pending:
                ...
                try:
                    ...
                    if invoice and invoice.get("isPaid"):
                        ...
                        # برای خرید سرویس، پیام تایید داخل finalize_online_payment ارسال می‌شود
                        # و عمداً قبل از تحویل سرویس قرار گرفته است. اگر اینجا دوباره ارسال شود،
                        # مسیر پولر می‌تواند ترتیب پیام‌ها را به‌هم بزند یا پیام تکراری بسازد.
                        # شارژ کیف پول سرویس تحویلی ندارد، بنابراین اطلاع‌رسانی آن را اینجا نگه می‌داریم.
                        if payment_kind == "wallet_charge":
                            try:
                                ...
                                logger.exception(
                                    "ارسال پیام تایید شارژ کیف پول از پولر ناموفق بود"
                                )
